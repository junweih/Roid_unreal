...
AAsteroid::AAsteroid()
{
	...
	static ConstructorHelpers::FObjectFinder<UBlueprint>
		FindExplosion(TEXT("Blueprint'/Game/Blueprints/ExplosionBP.ExplosionBP'"));
	...
	static ConstructorHelpers::FObjectFinder<USoundCue>
		explosionSound(TEXT("SoundCue'/Game/Sounds/ExplosionSound.ExplosionSound'"));
...
void AAsteroid::onHit(AActor * SelfActor, AActor * OtherActor, FVector NormalImpulse, const FHitResult & Hit)
{
